        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md">
            ...
            <form onSubmit={handleVerify} className="space-y-4">
                ...
                <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl text-center text-2xl font-bold tracking-widest focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    placeholder="000000"
                    maxLength="6"
                    required
                    disabled={loading}
